  ...
  try {
    ...
    if (resultRaw is String) {
      ...
      final bulletPoints = lines
          .where((line) =>
              line.trim().startsWith(RegExp(r'[-•●]')) || line.contains('▪'))
          .take(5)
          .toList();
...
''';
    ...
    resultFormatted =
        resultFormatted.replaceAll(RegExp(r'नोंद:.*$', dotAll: true), '').trim();

    setState(() {
      _diagnosisResult = resultFormatted.isEmpty
                ...
                DropdownButtonFormField<String>(
                  ...
                  items:
                      languages
                          ...
                          .toList(),
                  onChanged:
                      (val) => setState(() => _selectedLang = val ?? 'mr'),
                ),
                const SizedBox(height: 20),
